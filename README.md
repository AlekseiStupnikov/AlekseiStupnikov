...
### 5. Djangotesting
**Описание:** В проекте сделал тексты pytest для раздела ya_news, для раздела ya_note unittest тесты. Тесты выполнены по структуре (test_routes, test_content, test_logic) 
