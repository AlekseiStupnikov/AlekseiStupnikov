# Ступников Алексей — Python Backend Developer
...
Приветствую, дорогой гость! Это моя страница, как python backend developer. Я большую часть жизни занимался научной деятельностью, однако полюбил разработку за то, что какждый продукт находит свое воплощение в жизни. Из увлечений увлекаюсь музыкой, танцами и спортивными играми.
...
🛠 Технологии: `Django`, `Django REST Framework`, `JWT`, `Djoser`, `Pillow`, `Pytest`, `Postgres`, `React`, `Gunicorn`,
...
- **Разработчик:** Backend Developer - Ступников Алексей Александрович
...
🛠 Технологии: `Django`, `Django REST Framework`, `React`, `pytest`, `python`, `JWT`, `Djoser`, `Gunicorn`, `CI/CD`, `Postgres`, `psycopg2`, `Yaml`, `Docker`, `Docker Compose`, `Nginx(gateway)`, `Git Actions`.
...
---
### 3. Cafe-seats booking (командный проект)
**Описание:** Backend-приложение для управления бронированием столов в кафе, предоставляющее REST API для работы с пользователями, кафе, столами, временными слотами, бронированиями, блюдами и акциями.
Мои основные задачи по проекту:
- Проектирование и реализация схемы базы данных
- Разработка CRUD-операций
- Создание функционала бронирования
- Оптимизация и рефакторинг кода

🛠 Технологии: `FastApi`, `python`, `Loguru`, `Postgres`, `JWT`, `SQLAlchemy 2.0`, `Gunicorn`, `CI/CD`, `Postgres`, `Nginx(gateway)`, `psycopg2`, `Yaml`, `Docker`, `Docker Compose`, `Nginx(gateway)`, `Git Actions`.

🔗 [Исходники](https://github.com/Studio-Yandex-Practicum/cafe_seats_booking_backend_team2) доступ закрытый по требованию заказчика
...
### 5. Djangotesting
**Описание:** В проекте сделал тесты pytest для раздела ya_news, а для раздела ya_note unittest тесты. Тесты выполнены по структуре (test_routes, test_content, test_logic) 

🛠 Технологии: `Django`, `HTML`, `CSS`, `Bootstrap`, `Unittest`, `Pytest`, `GitHub`.

🔗 [Исходники](https://github.com/AlekseiStupnikov/django_testing)
...
---
### 6. YaMDb (командный проект)
**Описание:** Проект YaMDb собирает отзывы пользователей на произведения. Позволяет пользователям делиться своим мнением в ревью и комментировать ревью других пользователей!
Мои основные задачи по проекту:
- Проектирование и реализация схемы базы данных
- Разработка моделей
...
🔗 [Исходники](https://github.com/EgorKrestenov/api_yamdb)
...
🛠 Технологии: `BeautifulSoup4`, `PrettyTable`, `LXML`, `Argparse`, `Pytest`, `tqdm`, `Request`, `GitHub`.
...
### 9. Homeworkbot
**Описание:** Телеграмм бот для отслеживания статуса выполненного задания. 

🛠 Технологии: `Telebot`, `Requests`.

🔗 [Исходники](https://github.com/AlekseiStupnikov/homework_bot)
